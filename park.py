...
dfadana.sort_values("parks_percent_change_from_baseline", ascending = True,
...
dfistanbul.sort_values("parks_percent_change_from_baseline", ascending = True,
                 inplace = True, na_position ='last')
dfistanbul= dfistanbul.drop(columns=['country_region_code','retail_and_recreation_percent_change_from_baseline','country_region','iso_3166_2_code','place_id','grocery_and_pharmacy_percent_change_from_baseline', 
              'transit_stations_percent_change_from_baseline','sub_region_2','workplaces_percent_change_from_baseline','residential_percent_change_from_baseline'])
...
dfizmir.sort_values("parks_percent_change_from_baseline", ascending = True,
                 inplace = True, na_position ='last')
dfizmir= dfizmir.drop(columns=['country_region_code','retail_and_recreation_percent_change_from_baseline','sub_region_2','country_region','iso_3166_2_code','place_id','grocery_and_pharmacy_percent_change_from_baseline', 
...
dfkonya.sort_values("parks_percent_change_from_baseline", ascending = True,
                 inplace = True, na_position ='last')
dfkonya = dfkonya.drop(columns=['country_region_code','retail_and_recreation_percent_change_from_baseline','sub_region_2','country_region','iso_3166_2_code','place_id','grocery_and_pharmacy_percent_change_from_baseline', 
              'transit_stations_percent_change_from_baseline','workplaces_percent_change_from_baseline','residential_percent_change_from_baseline'])
...
dfsamsun.sort_values("parks_percent_change_from_baseline", ascending = True,
                 inplace = True, na_position ='last')
dfsamsun= dfsamsun.drop(columns=['country_region_code','sub_region_2','country_region','iso_3166_2_code','retail_and_recreation_percent_change_from_baseline','place_id','grocery_and_pharmacy_percent_change_from_baseline', 
              'transit_stations_percent_change_from_baseline','workplaces_percent_change_from_baseline','residential_percent_change_from_baseline'])
...
dferzurum.sort_values("parks_percent_change_from_baseline", ascending = True,
                 inplace = True, na_position ='last')
dferzurum= dferzurum.drop(columns=['country_region_code','country_region','sub_region_2','retail_and_recreation_percent_change_from_baseline','iso_3166_2_code','place_id','grocery_and_pharmacy_percent_change_from_baseline', 
              'transit_stations_percent_change_from_baseline','workplaces_percent_change_from_baseline','residential_percent_change_from_baseline'])
...
dfgaziantep.sort_values("parks_percent_change_from_baseline", ascending = True,
                 inplace = True, na_position ='last')
dfgaziantep=dfgaziantep.drop(columns=['country_region_code','sub_region_2','country_region','retail_and_recreation_percent_change_from_baseline','iso_3166_2_code','place_id','grocery_and_pharmacy_percent_change_from_baseline', 
              'transit_stations_percent_change_from_baseline','workplaces_percent_change_from_baseline','residential_percent_change_from_baseline'])
